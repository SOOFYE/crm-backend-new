...
export class CampaignentityAdditions1725193557672 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            CREATE TABLE "rescheduled_calls" (
                "id" uuid NOT NULL DEFAULT uuid_generate_v4(),
                "recordId" character varying(255) NOT NULL,
                "scheduledDate" TIMESTAMP NOT NULL,
                "createdAt" TIMESTAMP NOT NULL DEFAULT now(),
                "campaignId" uuid NOT NULL,
                "preprocessedDataId" uuid NOT NULL,
                CONSTRAINT "PK_5df447c99d46513a8e4883f7b70" PRIMARY KEY ("id")
            )
        `);
        ...
        await queryRunner.query(`
            DO $$
            BEGIN
                IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'campaigns_status_enum') THEN
                    CREATE TYPE "public"."campaigns_status_enum" AS ENUM('active', 'inactive');
                END IF;
            END
            $$;
        `);
        ...
        await queryRunner.query(`
            ALTER TABLE "rescheduled_calls" 
            ADD CONSTRAINT "FK_ce45e3b97463998045dd5e23bff" 
            FOREIGN KEY ("campaignId") REFERENCES "campaigns"("id") 
            ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
            ALTER TABLE "rescheduled_calls" 
            ADD CONSTRAINT "FK_9fad1a84805d122a3ef33e944b1" 
            FOREIGN KEY ("preprocessedDataId") REFERENCES "campaign_data"("id") 
            ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE IF EXISTS "public"."campaigns_status_enum"`);
